...
| 2026-08-22 | First live AI evals (Bedrock `claude-sonnet-4-6`, now the Bedrock default for that reason; `claude-sonnet-5` was not reachable from this account) | Refusal: guard 109/109, end to end 109/109, 0 missed; real-filing extraction and citation grounding recorded with provenance; prompts and Spanish phrasings not yet reviewed by a qualified person | [evals/README.md](../evals/README.md) and `evals/*/results/` |
